...
Run: /data/xinyua11/conda/envs/robocasa/bin/python gradient_analysis/cifar_gate.py
Writes gradient_analysis/cifar_gate_report.json
"""
import json
import sys
...
OUT = "/data/xinyua11/robocasa/gradient_analysis/cifar_gate_report.json"
CKPT = 6000
