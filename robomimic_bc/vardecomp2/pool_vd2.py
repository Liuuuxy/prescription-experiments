...
P="/data/xinyua11/robomimic_runs/vardecomp2"; RES=os.environ.get("RES",f"{P}/results.json")
...
while todo or act:
    while todo and len(act)<CONC:
        ...
        pr=subprocess.Popen([PY,f"{P}/run_vd2.py",r["name"],r["config"],r["mask"],str(r["seed"])],
