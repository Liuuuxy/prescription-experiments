"""ADPIL A1.3 response-surface run: BC-RNN under the v2 recipe on Can-PH.
Usage: run_surface.py NAME CONFIG MASK SEED   (CONFIG: rnn)
Identical to vardecomp2/run_vd2.py except: BC-RNN learner (cap run_cap.py config),
output under adpil/surface. v2 recipe: 500 epochs, ckpt every 50, best-of from 250
on the stratified 50-scene probe subset, probe+sealed eval at h500/h400."""
...
print("SRF_DONE",json.dumps({"best_ep":best_ep,"sel":best_score,"test":out["test"]["h500"]["J_deploy"]}),flush=True)
